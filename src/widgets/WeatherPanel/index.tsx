...
export const WeatherPanel = () => {
  ...
  if (!placeId) {
    return (
      <div className="flex flex-col justify-center items-center min-h-screen">
        ...
        <p className="text-black text-[36px] font-bold leading-normal font-pretendard mt-4">아직 선택된 위치가 없습니다!</p>
      </div>
    );
  }  
  ...
  <div className="flex flex-col items-start gap-[12px] w-[1080px] p-[32px] 
                  rounded-[16px] border-2 border-[#F2F2F2] bg-white 
                  shadow-[0px_0px_8px_2px_rgba(0,0,0,0.1)]">
    <DailyWeatherCard />
  </div>

   <div className="flex w-[1080px] p-[24px] flex-col items-start gap-[24px]
                  rounded-[16px] border border-[#F2F2F2] bg-white
                  shadow-[0px_0px_8px_2px_rgba(0,0,0,0.10)]">
    <HourlyTimeline />
  </div>

   <div className="flex w-[1080px] p-[24px] flex-col items-start gap-[12px] 
                rounded-[16px] border border-[#F2F2F2] bg-white 
                shadow-[0px_0px_8px_2px_rgba(0,0,0,0.10)]">
  <WeeklyForecast />
</div>
